...
contract('TestVerifier', accounts => {
    ...
    describe('zsnark verification testing', function () {
        ...
        it('correct proof', async function () { 
            ...
            assert.equal(result, true, "Correct proof rejected");
        })

        // Test verification with incorrect proof
        it('incorrect proof', async function () { 
            result = await this.contract.verifyTx.call(proof.proof.a, proof.proof.b, proof.proof.c, [9,0]);

            assert.equal(result, false, "Incorrect proof accepted");
        })
    });        
})